...
internals.normalizePassword = function(password) {
  ...
  if (password instanceof Object &&
      ...
      normal.id = password.id;

      if (password.secret) {
          normal.encryption = password.secret;
          normal.integrity = password.secret;
      }
      else {
          normal.encryption = password.encryption;
          normal.integrity = password.integrity;
      }
  }
  else {
      normal.encryption = password;
      normal.integrity = password;
  }
